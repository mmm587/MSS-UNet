...
class Polyp_datasets(Dataset):#定义一个Polyp数据加载器
    def __init__(self, path_Data, config, train=True, test_dataset = 'CVC-300'):#数据集路径、配置、
...
# ['isic17', 'isic18']
class football_datasets(Dataset):
    def __init__(self, path_Data, config, train=True, test_dataset = 'football'):
        super(football_datasets, self)
        if train:
            images_list = sorted(os.listdir(path_Data+'train/images/'))
            masks_list = sorted(os.listdir(path_Data+'train/masks/'))
            self.data = []
...
class CHASE_datasets(Dataset):
    def __init__(self, path_Data, config, train=True, test_dataset = 'CHASE'):
...
class DRIVE_datasets(Dataset):
    def __init__(self, path_Data, config, train=True, test_dataset = 'DRIVE'):
        super(DRIVE_datasets, self)
        if train:
            images_list = sorted(os.listdir(path_Data+'train/images/'))
            masks_list = sorted(os.listdir(path_Data+'train/masks/'))
            self.data = []
...
class BUSI_datasets(Dataset):
    def __init__(self, path_Data, config, train=True, test_dataset = 'BUSI'):
        super(BUSI_datasets, self)
        if train:
            images_list = sorted(os.listdir(path_Data+'train/images/'))
            masks_list = sorted(os.listdir(path_Data+'train/masks/'))
            self.data = []
...
# ['isic17', 'isic18']
class newdata_datasets(Dataset):
    def __init__(self, path_Data, config, train=True, test_dataset = 'newdata'):
        super(newdata_datasets, self)
        if train:
            images_list = sorted(os.listdir(path_Data+'train/images/'))
            masks_list = sorted(os.listdir(path_Data+'train/masks/'))
            self.data = []
