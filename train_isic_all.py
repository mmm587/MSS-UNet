...
import timm
#加载数据的方法
from datasets.dataset import NPY_datasets, Polyp_datasets, Isic_datasets,football_datasets,newdata_datasets,CHASE_datasets,DRIVE_datasets,BUSI_datasets
...
def main(config):
    ...
    if config.network == 'vmunet-v2':
        model = VMUNetV2(
            ...
            drop_path_rate=model_cfg['drop_path_rate'],#下降率
            load_ckpt_path=model_cfg['load_ckpt_path'],#预训练权重路径
